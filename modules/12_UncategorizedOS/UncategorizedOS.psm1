...
function Invoke-Verify { param($Context) return (New-ModuleResult -Name 'UncategorizedOS' -Status 'Succeeded' -Message 'Verified (stub)') }
function Invoke-Apply  { param($Context) return (New-ModuleResult -Name 'UncategorizedOS' -Status 'Succeeded' -Message 'Applied (stub)') }
