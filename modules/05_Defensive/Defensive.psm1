...
function Invoke-Verify { param($Context) return (New-ModuleResult -Name 'Defensive' -Status 'Succeeded' -Message 'Verified (stub)') }
function Invoke-Apply  { param($Context) return (New-ModuleResult -Name 'Defensive' -Status 'Succeeded' -Message 'Applied (stub)') }
