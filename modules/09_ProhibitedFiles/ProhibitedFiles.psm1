...
function Invoke-Verify { param($Context) return (New-ModuleResult -Name 'ProhibitedFiles' -Status 'Succeeded' -Message 'Verified (stub)') }
function Invoke-Apply  { param($Context) return (New-ModuleResult -Name 'ProhibitedFiles' -Status 'Succeeded' -Message 'Applied (stub)') }
