...
function Invoke-Verify { param($Context) return (New-ModuleResult -Name 'UnwantedSoftware' -Status 'Succeeded' -Message 'Verified (stub)') }
function Invoke-Apply  { param($Context) return (New-ModuleResult -Name 'UnwantedSoftware' -Status 'Succeeded' -Message 'Applied (stub)') }
